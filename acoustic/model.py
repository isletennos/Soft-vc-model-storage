...
URLS = {
    "hubert-discrete": "https://github.com/isletennos/Soft-vc-model-storage/blob/main/models/model-best.pt",
    "hubert-soft": "https://github.com/isletennos/Soft-vc-model-storage/blob/main/models/model-best.pt",
}
